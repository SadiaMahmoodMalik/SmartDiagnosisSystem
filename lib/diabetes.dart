...
class DiabetesSymptomsForm extends StatefulWidget {
  @override
  _DiabetesSymptomsForm createState() => _DiabetesSymptomsForm();
}

class _DiabetesSymptomsForm extends State<DiabetesSymptomsForm> {
  ...
  Future<void> predictPlacement() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          result = heartDiseaseString == "1.0" ? "Diabetes" : "Not diabetes";
        });
      } else {
  ...
  void _showPredictionDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        context,
        MaterialPageRoute(
        builder: (context) => DiabetesDoctorListPage(),
        ),
        );
        },
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Diabetes Symptoms Collector Form'),
      ),
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'HeartAttackorDisease',
                        hintText: "0: No, 1:Yes",
                      ),
                      keyboardType: TextInputType.number,
                      validator: (value) {
...
void main() async {
  ...
  await Firebase.initializeApp();
  runApp(MaterialApp(home: DiabetesSymptomsForm()));
}